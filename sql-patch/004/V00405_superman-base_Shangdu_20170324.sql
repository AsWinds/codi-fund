...
ALTER TABLE SYS_APP_VERSION ADD CONSTRAINT FK_REFERENCE_6 FOREIGN KEY (APP_ID)
      REFERENCES SYS_APP (APP_ID) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE SYS_ROLE_PRIV ADD CONSTRAINT FK_REFERENCE_4 FOREIGN KEY (PRIV_ID)
      REFERENCES SYS_PRIV (PRIV_ID) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE SYS_ROLE_PRIV ADD CONSTRAINT FK_REFERENCE_5 FOREIGN KEY (ROLE_ID)
...
ALTER TABLE SYS_USER_SESSION ADD CONSTRAINT FK_REFERENCE_1 FOREIGN KEY (USER_ID)
