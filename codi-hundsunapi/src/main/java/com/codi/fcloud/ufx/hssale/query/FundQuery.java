...
import com.codi.trade.service.FundQueryService;

@Service("fundQueryService")
public class FundQuery extends UfxSDKFactory implements FundQueryService {
    ...
    protected String getTarget() {
        return UrlConstants.PREFIX_SALE + UrlConstants.FUNDINFO_QRY;
    }
